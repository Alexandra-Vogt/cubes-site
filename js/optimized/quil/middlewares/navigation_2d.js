...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__6625_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_6626 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_6627 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_6626);
var pos_6628 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_6626);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_6627);

var tr__6447__auto___6629 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_6627) - cljs.core.first(pos_6628)),(((quil.core.height() / (2)) / zoom_6627) - cljs.core.second(pos_6628))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__6447__auto___6629);
...
var G__6630 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__6631 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__6630,G__6631) : user_mouse_dragged.call(null,G__6630,G__6631));
...
return (function (state,event){
var G__6632 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__6633 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__6632,G__6633) : user_mouse_wheel.call(null,G__6632,G__6633));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
