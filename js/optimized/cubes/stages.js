...
var speed = quil.core.sqrt((quil.core.pow((function (){var x__4219__auto__ = player_speed_x;
var y__4220__auto__ = (- player_speed_x);
return ((x__4219__auto__ > y__4220__auto__) ? x__4219__auto__ : y__4220__auto__);
})(),(2)) + quil.core.pow(player_speed_y,(2))));
...
return cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$stage,cljs.core.cst$kw$speed,cljs.core.cst$kw$max_DASH_score,cljs.core.cst$kw$time,cljs.core.cst$kw$score,cljs.core.cst$kw$player,cljs.core.cst$kw$point_DASH_cubes,cljs.core.cst$kw$distance,cljs.core.cst$kw$enemies,cljs.core.cst$kw$ignore_DASH_keypress],[(cljs.core.truth_(restart)?"game":"score"),(0),max_score,(cljs.core.truth_(restart)?(0):cljs.core.cst$kw$time.cljs$core$IFn$_invoke$arity$1(state)),(cljs.core.truth_(restart)?(0):cljs.core.cst$kw$score.cljs$core$IFn$_invoke$arity$1(state)),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$x,(cljs.core.truth_(restart)?(-20):cljs.core.cst$kw$x.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$player.cljs$core$IFn$_invoke$arity$1(state))),cljs.core.cst$kw$y,cljs.core.cst$kw$y.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$player.cljs$core$IFn$_invoke$arity$1(state))], null),(cljs.core.truth_(restart)?cljs.core.PersistentVector.EMPTY:cljs.core.cst$kw$point_DASH_cubes.cljs$core$IFn$_invoke$arity$1(state)),(cljs.core.truth_(restart)?(0):cljs.core.cst$kw$distance.cljs$core$IFn$_invoke$arity$1(state)),(cljs.core.truth_(restart)?cljs.core.PersistentVector.EMPTY:cljs.core.cst$kw$enemies.cljs$core$IFn$_invoke$arity$1(state)),(cljs.core.truth_(quil.core.key_pressed_QMARK_())?cljs.core.cst$kw$ignore_DASH_keypress.cljs$core$IFn$_invoke$arity$1(state):false)]);
});
